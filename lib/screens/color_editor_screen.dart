...
class _ColorEditorScreenState extends State<ColorEditorScreen> {
  ...
  String _colorLabel(String k) {
    ...
    switch (k) {
      case 'ganttMonthGridLine':
        return l.ganttMonthGridLine;
      case 'ganttWeekGridLine':
        return l.ganttWeekGridLine;
      case 'ganttRowDivider':
        return l.ganttRowDivider;
      case 'ganttWeekendStripe':
        return l.ganttWeekendStripe;
      case 'ganttNowLine':
        return l.ganttNowLine;
      case 'ganttHeaderBackground':
        return l.ganttHeaderBackground;
      case 'ganttHeaderWeekendBg':
        return l.ganttHeaderWeekendBg;
      case 'ganttHeaderDivider':
        return l.ganttHeaderDivider;
      case 'ganttHeaderText':
        return l.ganttHeaderText;
      case 'ganttHeaderWeekendText':
        return l.ganttHeaderWeekendText;
      case 'ganttHeaderTodayText':
        return l.ganttHeaderTodayText;
      case 'ganttHeaderTodayBg':
        return l.ganttHeaderTodayBg;
      case 'ganttDeadlineTaskFill':
        return l.ganttDeadlineTaskFill;
      case 'ganttRangeTaskHigh':
        return l.ganttRangeTaskHigh;
      case 'ganttRangeTaskMedium':
        return l.ganttRangeTaskMedium;
      case 'ganttRangeTaskLow':
        return l.ganttRangeTaskLow;
      case 'ganttRangeTaskDefault':
        return l.ganttRangeTaskDefault;
      case 'ganttTaskText':
        return l.ganttTaskText;
      case 'homePageBackground':
        return l.homePageBackground;
      case 'homeCardBackground':
        return l.homeCardBackground;
      case 'homeCardBorder':
        return l.homeCardBorder;
      case 'homeProgressValue':
        return l.homeProgressValue;
      case 'homeProgressSymbol':
        return l.homeProgressSymbol;
      case 'homeProgressCaption':
        return l.homeProgressCaption;
      case 'homeTitleText':
        return l.homeTitleText;
      case 'homeBodyText':
        return l.homeBodyText;
      case 'commonFabBackground':
        return l.commonFabBackground;
      case 'commonFabIcon':
        return l.commonFabIcon;
      case 'commonButtonBackground':
        return l.commonButtonBackground;
      case 'commonButtonText':
        return l.commonButtonText;
      case 'commonInputFill':
        return l.commonInputFill;
      case 'commonInputLabel':
        return l.commonInputLabel;
      case 'commonInputText':
        return l.commonInputText;
      case 'commonInputBorder':
        return l.commonInputBorder;
      case 'commonAppBarBackground':
        return l.commonAppBarBackground;
      case 'commonAppBarTitle':
        return l.commonAppBarTitle;
      case 'commonErrorText':
        return l.commonErrorText;
      case 'commonDivider':
        return l.commonDivider;
      default:
        return k;
    }
  }
  ...
  Future<void> _createNew() async {
    ...
    for (final g in _groups) {
      for (final k in g.keys) {
        p.setColorByKey(
          k,
          _data.colorByKey(k, Brightness.light),
          Brightness.light,
        );
        p.setColorByKey(
          k,
          _data.colorByKey(k, Brightness.dark),
          Brightness.dark,
        );
      }
    }
  ...
  Future<void> _apply() async {
    ...
    if (mounted) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('${l.apply}: $_data.name')));
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          l.colorSettings,
          style: AppTheme.pageTitleStyle(context, color: t.primaryColor),
        ),
        actions: [
          IconButton(
            icon: Icon(
              Icons.delete_outline,
              color: _canDelete ? t.colorScheme.error : t.disabledColor,
            ),
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text(
            group.title,
            style: AppTheme.sectionTitleStyle(context, color: t.primaryColor),
          ),
        ),
      ...
      child: Row(
        children: [
          ...
          SizedBox(
            ...
            child: _colorBlock(
              lightColor,
              () => _editColor(key, Brightness.light),
            ),
          ),
          const SizedBox(width: _blockGap),
          SizedBox(
            ...
            child: _colorBlock(
              darkColor,
              () => _editColor(key, Brightness.dark),
            ),
          ),
        ],
      ),
